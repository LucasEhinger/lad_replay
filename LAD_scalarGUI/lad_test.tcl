...
proc Draw {scalchan layer number orientation error minnumber maxnumber}   {
    ...
    if {$orientation == "TF" || $orientation == "BF"} {incr X1 -46} elseif {$orientation == "TD" || $orientation == "BD"} {incr X1 46}
    if {$orientation == "TF" || $orientation == "TD"} {incr Y1 15} elseif {$orientation == "BF" || $orientation == "BD"} {incr Y1 -15}
