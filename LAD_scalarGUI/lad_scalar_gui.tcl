...
if {$detector == 0} {
    ...
    set layers {0 1 2 3 4}
    set layernames {"fadc-W0S0-disc" "fadc-W0S1-disc" "fadc-W1S0-disc" "fadc-W1S1-disc" "fadc-W2S0-disc"}
} else {
...
#    wm minsize . 1250 875
    if {$swapxy == 0} then {
      ...
      wm geometry . 1000x[expr [llength $layers]*159]
    }
    wm geometry . +0+0
