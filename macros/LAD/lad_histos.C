  ...
  for (const auto &prefix : prefixes) {
    ...
    hist1DCommands.insert(
        ...
        {{prefix + "_h1_gem_clustWidthU_0", "X cluster size Layer 0; cluster size", prefix + ".gem.clust.nstrip", 10,
         ...
         {prefix + "_h1_gem_time_0", "Time Mean Layer 0; Time Mean", prefix + ".gem.sp.time", 100, 0, 120,
          prefix + ".gem.sp.layer<1"},
         {prefix + "_h1_gem_time_1", "Time Mean Layer 1; Time Mean", prefix + ".gem.sp.time", 100, 0, 120,
          prefix + ".gem.sp.layer>0"},
         {prefix + "_h1_gem_ADCMean_0", "ADC Mean Layer 0; ADC Mean", prefix + ".gem.sp.adc", 100, 0, 20000,
          prefix + ".gem.sp.layer<1"},
         {prefix + "_h1_gem_ADCMean_1", "ADC Mean Layer 1; ADC Mean", prefix + ".gem.sp.adc", 100, 0, 20000,
          prefix + ".gem.sp.layer>0"},
         {prefix + "_h1_gem_ADCAsym_0", "ADC Asymmetry Layer 0; ADC Asymmetry", prefix + ".gem.sp.asym", 100, -1, 1,
          prefix + ".gem.sp.layer<1"},
         {prefix + "_h1_gem_ADCAsym_1", "ADC Asymmetry Layer 1; ADC Asymmetry", prefix + ".gem.sp.asym", 100, -1, 1,
          prefix + ".gem.sp.layer>0"},
         {prefix + "_h1_gem_TimeDiff_0", "Time Difference Layer 0; Time Difference", prefix + ".gem.sp.dt", 100, -40, 40,
          prefix + ".gem.sp.layer<1"},
         {prefix + "_h1_gem_TimeDiff_1", "Time Difference Layer 1; Time Difference", prefix + ".gem.sp.dt", 100, -40, 40,
          prefix + ".gem.sp.layer>0"},
         {prefix + "_h1_gem_TimeCorr_0", "Corrected Time Layer 0; Corrected Time", prefix + ".gem.sp.ct", 100, -40, 40,
          prefix + ".gem.sp.layer<1"},
         {prefix + "_h1_gem_TimeCorr_1", "Corrected Time Layer 1; Corrected Time", prefix + ".gem.sp.ct", 100, -40, 40,
          prefix + ".gem.sp.layer>0"}});
