...
void replay_no_reference_times_coin(Int_t RunNumber = 0, Int_t MaxEvent = 0) {
  ...
  const char *ROOTFileNamePattern = "ROOTfiles/LAD_COIN_noReferenceTime_%d_%d.root";
  ...
  gHcParms->AddString("g_ctp_no_LAD_reference_times_filename", "PARAM/LAD/GEN/l_no_reference_times.param");
  gHcParms->Load(gHcParms->GetString("g_ctp_no_LAD_reference_times_filename"));
  ...
  gHcParms->Load(gHcParms->GetString("g_ctp_no_hms_timing_windows_filename"));
  gHcParms->AddString("g_ctp_no_LAD_timing_windows_filename", "PARAM/LAD/GEN/ldet_cuts_no_timing_windows.param");
  gHcParms->Load(gHcParms->GetString("g_ctp_no_LAD_timing_windows_filename"));
  ...
  */
  ...
  THcSecondaryKine *hkin_secondary =
      new THcSecondaryKine("H.kin.secondary", "HMS Single Arm Kinematics", "H", "P.kin.primary");
